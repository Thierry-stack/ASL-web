...
function HeroGeometric({
  ...
  description = "Video-based courses with captions, large controls, and a layout built for deaf and hard-of-hearing learners.",
  className,
}: {
  badge?: string;
  title1?: string;
  title2?: string;
  description?: string;
  /** e.g. min-h-[calc(100dvh-4rem)] when using a sticky top bar */
  className?: string;
}) {
